...
def send_message_to_output_topic():
    ...
    consumer = KafkaConsumer('input',bootstrap_servers='kafka-service.default.svc.cluster.local:9092')
    producer = KafkaProducer(bootstrap_servers='kafka-service.default.svc.cluster.local:9092')
